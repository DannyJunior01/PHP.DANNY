    ...
    <section class="inicio" id="inicio">
        <div class="contenido-seccion">
            <header>
                ...
                <div class="logo">
                    Danny<span class="color">J</span>
                </div>
            </header>
            <div class="info">
                <h1>Francisco Daniel Bravp Aburto</h1>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                ...
                                <p>Universidad Politecnica de Lazaro Cardenas</p>
                ...
                <div class="col">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <h4>Wesard Hearth</h4>
                                <p>Administrador y auxiliar de almacen</p>
        ...
        <div class="contenido-seccion">
            ...
            <div class="fila">
                <div class="col">
                    ...
                    <span class="info-contacto">+52 753-163-2660</span>
                </div>
                <div class="col">
                    <h2>
                        <i class="fa-solid fa-envelope"></i> Correo
                    </h2>
                    <span class="info-contacto">franciscodaniel2018@icloud.com</span>
                </div>
                <div class="col">
                    <h2>
                        <i class="fa-solid fa-globe"></i> Localidad
                    </h2>
                    <span class="info-contacto">Lazaro Cardenas Michoacan</span>
                </div>
            </div>
        </div>
    </section>
